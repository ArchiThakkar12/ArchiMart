...
import com.archimart.repository.CartProductRepository;
import com.archimart.repository.CustomerCartRepository;
...
public class CustomerCartService {
    ...
    public Integer addProductToCart(CustomerCartDTO customerCartDTO) throws ArchiMartException {
    ...
    public Set<CartProductDTO> getProductsFromCart(String customerEmailId) throws ArchiMartException {
        ...
        CustomerCart cart = cartOptional
                .orElseThrow(() -> new ArchiMartException("CustomerCartService.NO_CART_FOUND"));
        if (cart.getCartProducts().isEmpty()) {
            throw new ArchiMartException("CustomerCartService.NO_PRODUCT_ADDED_TO_CART");
        }
    ...
    public void deleteProductFromCart(String customerEmailId, Integer productId) throws ArchiMartException {
        Optional<CustomerCart> cartOptional = customerCartRepository.findByCustomerEmailId(customerEmailId);
        CustomerCart cart = cartOptional
                .orElseThrow(() -> new ArchiMartException("CustomerCartService.NO_CART_FOUND"));
        if (cart.getCartProducts().isEmpty()) {
        ...
        if (selectedProduct == null) {
            throw new ArchiMartException("CustomerCartService.PRODUCT_ALREADY_NOT_AVAILABLE");
        }
    ...
    public void deleteAllProductsFromCart(String customerEmailId) throws ArchiMartException {
        Optional<CustomerCart> cartOptional = customerCartRepository.findByCustomerEmailId(customerEmailId);
        CustomerCart cart = cartOptional
                .orElseThrow(() -> new ArchiMartException("CustomerCartService.NO_CART_FOUND"));
